...
extension TaglistCollection : UICollectionViewDataSource ,UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.viewTag.backgroundColor = UIColor.white
        if indexPath.item < self.tagNames.count {
            ...
            if indexPath.row == selectdIndex
            {
                ...
                cell.lblTag.textColor = BLColors.BLThemeColor
                cell.viewTag.layer.borderColor = BLColors.BLThemeColor.cgColor
                cell.viewTag.layer.borderWidth = 1.0
                cell.configureCell()
            }
            else
            {
                ...
                cell.isCellSelected = self.selectedTagAck[indexPath.item]
                cell.delegate = self as TagColllectionCellDelegate
                cell.lblTag.textColor = BLColors.BL_FeedHeadingColor
                cell.viewTag.layer.borderColor = BLColors.BL_FeedSeparatorColor.cgColor
                cell.viewTag.layer.borderWidth = 1.0
                cell.configureCell()
            }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
       ...
       // print(indexPath.section)
        ...
        if(self.allowMultipleSelection == true) {
            ...
            if self.selectdIndex != indexPath.item
            {
               
                let oldValue = self.selectdIndex
                self.selectdIndex = indexPath.item
                
                if let cell = collectionView.cellForItem(at: IndexPath(item: oldValue, section: 0)) as? TagCollectionCell
                {
                    cell.lblTag.textColor = BLColors.BL_FeedHeadingColor
                    cell.viewTag.layer.borderColor = BLColors.BL_FeedSeparatorColor.cgColor
                    cell.viewTag.layer.borderWidth = 1.0
                ...
                if let cell = collectionView.cellForItem(at: IndexPath(item: indexPath.item, section: 0)) as? TagCollectionCell
                {
                    cell.lblTag.textColor = BLColors.BLThemeColor
                    cell.viewTag.layer.borderColor = BLColors.BLThemeColor.cgColor
                    cell.viewTag.layer.borderWidth = 1.0
