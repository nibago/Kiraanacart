...
class ContactusViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.subjectTextView.placeholderFont = UIFont(name: KCFonts.RegularFont, size: KCFonts.MediumFontSize)
        self.subjectTextView.font = UIFont(name: KCFonts.RegularFont, size: KCFonts.MediumFontSize)
        self.subjectTextView.textColor = UIColor.black
        
        self.DescriptionTextView.placeholder = "Enter Description"
        self.DescriptionTextView.placeholderFont = UIFont(name: KCFonts.RegularFont, size: KCFonts.MediumFontSize)
        self.DescriptionTextView.font = UIFont(name: KCFonts.RegularFont, size: KCFonts.MediumFontSize)
