...
class initialViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        slides = createSlides()
//        slides.skipbuttonClick.addTarget(self, action: #selector(coolFunc(_:)), for: .touchUpInside)
...
//        self.navigationController?.pushViewController(nextViewController, animated:true)
    ...
    func createSlides() -> [Slide] {
        let slide1:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
               ...
               slide4.labelTitle.text = "Fast Delivery"
               slide4.labelDesc.text = "Fast Delivery to home, office and wherever you are"
               slide4.skipbuttonClick.addTarget(self, action: #selector(coolFunc(_:)), for: .touchUpInside)
               
               
               let slide5:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
               slide5.imageView.image = UIImage(named: "ic_onboarding_5")
               slide5.labelTitle.text = "Live Tracking"
               slide5.labelDesc.text = "Real Time Tracking of your grocery on the app ofter ordered"
               slide5.skipbuttonClick.addTarget(self, action: #selector(coolFunc(_:)), for: .touchUpInside)
